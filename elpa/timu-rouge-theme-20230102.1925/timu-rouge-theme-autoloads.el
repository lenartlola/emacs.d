;;; timu-rouge-theme-autoloads.el --- automatically extracted autoloads
;;
;;; Code:
...
(if (fboundp 'register-definition-prefixes) (register-definition-prefixes "timu-rouge-theme" '("timu-rouge")))

;;;***

;;;### (autoloads nil nil ("timu-rouge-theme-pkg.el") (0 0 0 0))
